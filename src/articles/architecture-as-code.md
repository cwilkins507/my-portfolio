...
![PlantUML sequence diagram showing user to API to database service communication on AWS](/images/PlantUML-example.png)
...
![Mermaid flowchart diagram rendered from markdown code](/images/Mermaid-example.png)
...
![Miro whiteboard showing a visual CRUD architecture diagram](/images/Miro-example.png)
