...
export const CONSULTING_OVERVIEW = Object.freeze({
  ...
  paths: Object.freeze([
    Object.freeze({
      ...
      name: 'Know what to automate first.',
      description: 'Rank one recurring workflow by business value, risk, and feasibility—then decide whether to implement it, defer it, or stop.',
    ...
    Object.freeze({
      ...
      name: 'Turn AI coding into a team practice.',
      description: 'Take one approved issue through shared context, existing CI, human review, and a handoff your team can repeat.',
    ...
    Object.freeze({
      ...
      name: 'Make the technical decision before you build.',
      description: 'Leave with clear architecture, boundaries, controls, and an implementation sequence before committing the team to a build.',
    ...
    Object.freeze({
      ...
      name: 'Replace the manual workflow with a maintainable system.',
      description: 'Connect the forms, spreadsheets, CRM, and backend logic so information moves without repeated entry or one person’s memory.',
      href: INTRO_CALL.href,
